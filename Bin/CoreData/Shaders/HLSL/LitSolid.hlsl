    ...
    out float4 oPos : OUTPOSITION)
{
    ...
    oWorldPos = float4(worldPos, GetDepth(oPos));
        ...
        #ifdef ENVCUBEMAP
            #ifdef VR
            oReflectionVec = worldPos - cCameraPos[iInstanceID & 1];
            #else
    ...
    out float4 oColor : OUTCOLOR0)
{
    ...
    // Get fog factor
        ...
        #ifdef SPECULAR
            #ifdef VR
            float spec = GetSpecular(normal, cCameraPosPS[iInstanceID & 1] - iWorldPos.xyz, lightDir, cMatSpecColor.a);
            #else
        ...
        oColor = float4(finalColor, diffColor.a);//float4(GetFog(finalColor, fogFactor), diffColor.a);
    #endif
}
